...
final class LocationPickerViewController: UIViewController {
    ...
    lazy var locationButton: Button = {
        ...
        $0.setImage(#imageLiteral(resourceName: "ic_map_pin"), for: UIControl.State())
	...
	lazy var searchController: UISearchController = {
        ...
        $0.searchBar.textField?.textColor = UIColor(hex6: 0xf4f4f4)
        $0.searchBar.textField?.setPlaceHolderTextColor(UIColor(hex6: 0xf8f8f8))
...
//        pin.pinTintColor = UIColor(hex: 0xFF2DC6)
        ...
        pin.image = #imageLiteral(resourceName: "ic_map_pin")
	...
	func selectLocationButton() -> UIButton {
        ...
        button.backgroundColor = UIColor(hex6: 0x007AFF)
		button.setTitleColor(.white, for: UIControl.State())
        button.layer.borderWidth = 2
        button.layer.borderColor = UIColor(hex6: 0x007AFF).cgColor
